 ...
 * @return {string}
 */
function mpdate(string: string, timestamp: number | string | Date = new Date): string {
...
namespace mpdate {
   ...
   */
  _functions.D = date => {
    return i18n(weekdays[date.getDay()], "mpdate").substr(0, 3);
  }
  /**
   ...
   */
  _functions.l = date => {
    return i18n(weekdays[date.getDay()], "mpdate");
  };
  /**
   ...
   */
  _functions.F = date => {
    return i18n(months[date.getMonth()], "mpdate");
  };
  /**
   ...
   */
  _functions.M = date => {
    return i18n(months[date.getMonth()], "mpdate").substr(0, 3);
  };
  /**
