...
namespace OutDated {
  ...
  class Server extends EventTarget {
    ...
    #idb = new IndexedDB<{
      ...
      routes: {
        Records: { type: "string"; path: string; } | { type: "regexp"; path: RegExp; };
        Indices: "";
      }
      log: {
  ...
  interface Server {
    ...
    addEventListener(type: string, listener: (this: Server, ev: Event) => any, options?: boolean | AddEventListenerOptions): void;
    removeEventListener<K extends keyof ServerEventMap>(type: K, listener: (this: Server, ev: ServerEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
    removeEventListener(type: string, listener: (this: Server, ev: Event) => any, options?: boolean | AddEventListenerOptions): void;
